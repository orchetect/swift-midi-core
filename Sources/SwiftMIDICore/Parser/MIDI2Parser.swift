...
extension MIDI2Parser {
    ...
    public func parsedEvents(
        in packetData: UniversalMIDIPacketData<some Any, some Any> // timestamp and source are not used here
    ) -> [MIDIEvent] {
...
extension MIDI2Parser {
    ...
    func parseSystemRealTimeAndCommon(
        ...
        func dataByte1() -> UInt8 {
            bytes[bytes.startIndex.advanced(by: 1)]
        }
        func dataByte2() -> UInt8 {
    ...
    private func parseData128BitMixedDataSetSysEx(
        ...
        case .header:
            // TODO: finish this
            assertionFailure("Not implemented yet. Please file a SwiftMIDI bug report.")
        case .payload:
            // TODO: finish this
            assertionFailure("Not implemented yet. Please contact SwiftMIDI bug report.")
        }
