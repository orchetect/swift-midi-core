...
extension MIDIEvent {
    ...
    /// > Tip:
    /// >
    /// > If it appears you are receiving duplicate NRPN messages, it has to do with Core MIDI
...
extension MIDIEvent.NRPN: Equatable { }

extension MIDIEvent.NRPN: Hashable { }
