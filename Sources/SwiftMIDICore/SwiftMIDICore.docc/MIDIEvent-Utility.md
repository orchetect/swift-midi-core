...
- Note: This is an advanced feature. These messages are optional and not generally intended to be used by end users. Core MIDI on Apple platforms already provides accurate timing at the system/driver level for devices and virtual endpoints and is more than sufficient in the majority of cases.
