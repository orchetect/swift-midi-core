...
@Suite
struct MainThreadSynchronizedPThreadMutex_Tests {
    ...
    /// - Note: This test requires Thread Sanitizer enabled in the Test Plan.
    @Test
    func concurrentMutations_taskGroup_mainActor() async {
        let wrapper = Wrapper()
    ...
    /// - Note: This test requires Thread Sanitizer enabled in the Test Plan.
    @MainActor @Test
    func concurrentMutations_taskGroup_mainActor_onMainActor() async {
        let wrapper = Wrapper()
